...
export function CouponCreationDialog({
  ...
  // Step 2 — coupon editor as a tall bottom sheet with overlay, portaled to cover the full device screen.
  if (selected) {
    const node = (
      <div role="presentation" onClick={onDismiss} style={{ position: 'absolute', inset: 0, zIndex: 50, display: 'flex', alignItems: 'flex-end', background: 'rgba(0,0,0,0.32)' }}>
        <div onClick={(e) => e.stopPropagation()} className="woopos-slide-up" style={{ width: '100%', height: '92%', background: 'var(--color-surface)', borderRadius: 'var(--radius-lg) var(--radius-lg) 0 0', display: 'flex', flexDirection: 'column', boxShadow: 'var(--shadow-normal-large)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)', padding: 'var(--space-md) var(--space-md)', minHeight: 'var(--size-xsmall)', flex: 'none' }}>
          ...
          <div style={{ padding: 'var(--space-md)', flex: 'none' }}>
  ...
  // Step 1 — discount-type selection bottom sheet, portaled to cover the full device screen.
  const node = (
    <div role="presentation" onClick={onDismiss} style={{ position: 'absolute', inset: 0, zIndex: 40, display: 'flex', alignItems: 'flex-end', background: 'rgba(0,0,0,0.32)' }}>
      <div onClick={(e) => e.stopPropagation()} className="woopos-slide-up" style={{ width: '100%', background: 'var(--color-surface-bright)', borderRadius: 'var(--radius-lg) var(--radius-lg) 0 0', padding: 'var(--space-lg) var(--space-lg) var(--space-xl)', boxShadow: 'var(--shadow-normal-large)' }}>
